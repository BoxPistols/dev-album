...
export const CURATED_SOURCES: Source[] = [
  ...
  },
  {
    ...
    usedBy: ["/ai-ml/jev/jev-overview", "/ai-ml/jev/jev-account", "/ai-ml/jev/jev-setup", "/ai-ml/jev/jev-primitives", "/ai-ml/jev/jev-state-design", "/ai-ml/jev/jev-app-ideas", "/ai-ml/jev/jev-triage-app", "/ai-ml/jev/jev-chart-picker-app", "/ai-ml/jev/jev-feedback-app", "/ai-ml/jev/jev-clinic-app", "/ai-ml/jev/jev-leads-app", "/ai-ml/jev/jev-advanced"],
  },
  {

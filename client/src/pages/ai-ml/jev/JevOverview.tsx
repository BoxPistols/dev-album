        ...
        <div className="space-y-12 mt-8">
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-6 leading-relaxed">
              ...
              になっています。名前はモデルIDにも使われていて、SDKの既定モデルは
                ...
                <div className="rounded-lg border border-border bg-muted p-4">
                  ...
                  <ul className="text-sm text-muted-foreground space-y-1.5">
                    ...
                    <li>
                      ...
                      : 名前付きの質問の集まり。型はnoul / choice / scoreの3つ
                    </li>
                    <li>
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-6 leading-relaxed">
              ...
              にある例をそのまま示します。サポートチケットの本文をstateに入れ、
              「このチケットは何についてか」を3
  ...
  "probabilities": { "billing": 0.9, "technical": 0.06, "other": 0.04 }
          ...
          <section>
            ...
            <InfoBox type="info" title="速さと料金について">
              ...
              公式SDKに同梱されたスキーマには、出力トークンが「currently free of
              charge」と記されています（執筆時点）。
            </InfoBox>
          </section>

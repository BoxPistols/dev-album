  ...
  -H "Authorization: Bearer $TYPESAFE_API_KEY"`}
          ...
          <section>
            ...
            <div className="rounded-xl border border-border bg-card p-6">
              <div className="space-y-3">
                {[
                  {
                    step: "1",
                    label: "VercelのチームでAI Gatewayのクレジットを購入する",
                  ...
                  {
                    step: "4",
                    label: "モデル一覧でtypesafe-ai/jevが見えることを確認する",
            ...
            <InfoBox type="info" title="ルートBでの呼び出し方">
              ...
              Vercelのナレッジベース記事「How to classify, route, and score with
              Jev and AI SDK」に沿って呼び出し部分を置き換えてください。

        ...
        <div className="space-y-12 mt-8">
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-4 leading-relaxed">
              ...
              トランクベース開発は、全員が少なくとも 24 時間に 1 回は main
              へ統合することで、
...
git push -u origin feature/add-search`}
    ...
    commit id: "deploy"`}
            ...
            <InfoBox type="info" title="仕様は範囲、実測は運用">
              trunkbaseddevelopment.com は「短命」を
              <strong>数日（a couple of days）</strong>とし、
              2日を超えると長寿命ブランチ化のリスクがあると書いています。実測ではレビュー待ちで
              さらに伸びることがあります。理由はコードの完成度ではなく、

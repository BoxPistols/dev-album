        ...
        <div className="space-y-12 mt-8">
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-6 leading-relaxed">
              スプリントは 1
              か月以内の固定期間で、すべての作業とイベントを内包する器です。 Scrum
              Guide
              は一貫性を保つために長さを固定すると定めており、期間は途中で延長しません。
    ...
    RETRO --> END["スプリント終了 → 次へ"]`}
          ...
          <section>
            <Quiz
              ...
              explanation="スプリントは固定タイムボックスで、途中で延長しません。一定のリズムを保つことで指標が比較可能になり、見積もりや計画の精度を経験的に高められます。長さ自体は 1 か月以内の範囲で、チームに合わせて選びます。"
            />
          </section>

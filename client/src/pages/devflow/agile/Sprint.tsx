...
const ceremonies = [
  {
    ...
    timebox: "1か月スプリントで最大 8 時間。短いスプリントなら比例して短く。",
  },
  {
    title: "デイリースクラム",
    purpose:
  ...
  },
  {
    ...
    timebox: "1か月スプリントで最大 4 時間。短いスプリントなら比例して短く。",
  },
  {
    title: "スプリントレトロスペクティブ",
    purpose: "チームの進め方をふりかえり、次に試す改善を具体的に決める。",
    timebox: "1か月スプリントで最大 3 時間。短いスプリントなら比例して短く。",
  },
];
        ...
        <div className="space-y-12 mt-8">
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-6 leading-relaxed">
              ...
              それぞれにタイムボックス（上限時間）が決められており、
              下の時間はスクラムガイドが示す
              <strong>1 か月スプリントでの上限</strong>です。 実際には 1〜2
              週間スプリントが多いため、時間も比例して短く運用します。
            </p>

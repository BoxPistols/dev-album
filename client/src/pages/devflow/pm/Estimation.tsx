      ...
      <div className="max-w-4xl mx-auto px-4 md:px-8 py-12">
        ...
        >
          <p>
            ...
            所要時間は割り込みや待ちに左右されますが、「A は B よりだいたい 2
            倍大きい」という項目同士の大小関係は、その影響を受けにくいままです。
            大小の比較で大きさを表し、実績で時間に換算するのが相対見積もりの発想です。
        ...
        <div className="space-y-12 mt-8">
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-6 leading-relaxed">
              ...
              <strong>相対的な比較</strong>は、環境が変わっても崩れにくい情報です。
              相対見積もりはこの比較で項目の大きさを表し、時間への換算は実績に任せます。
            </p>

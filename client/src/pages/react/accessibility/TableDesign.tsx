  ...
  border-bottom: 1px solid #f1f5f9;
          ...
          <section>
            <Quiz
              ...
              explanation="HTML 仕様では、headers 属性によるヘッダーとセルの対応づけは同じテーブル内でのみ成立します（WHATWG HTML: in the same table）。入れ子にすると内側のセルは外側のヘッダーと結び付けられず、「このセルはどのヘッダーに対応するのか」を支援技術に伝えられません。代替案として、アコーディオン行やマスター/ディテールパターンを使いましょう。"
            />
          </section>

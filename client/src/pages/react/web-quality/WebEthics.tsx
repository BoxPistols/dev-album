      ...
      <button type="submit" className="bg-blue-600 text-white px-4 py-2 rounded">
        送信する
            ...
            <p className="text-foreground/80 mb-4 leading-relaxed">
              ...
              政府調達の標準として JIS X 8341-3:2016 の適合レベル AA 準拠を挙げています。
              JIS X 8341-3 の一致規格は WCAG 2.0（ISO/IEC 40500:2012 として国際規格化）で、
              WCAG 2.1 / 2.2 への対応は同ガイドブックでは検討しておくべき事項として位置づけられています。
              公共サイトについては総務省「みんなの公共サイト運用ガイドライン（2024 年版）」も AA 適合を推奨しています。
            </p>

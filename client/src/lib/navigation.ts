...
export const pages: PageInfo[] = [
  ...
  { step: 31, path: '/claude-mux/cmux/agent-teams', title: 'cmux と Agent Teams', sectionId: 'cmux', manualId: 'claude-mux' },
  { step: 32, path: '/claude-mux/cmux/browser-api', title: 'ビルトインブラウザと Scriptable API', sectionId: 'cmux', manualId: 'claude-mux' },
  { step: 33, path: '/claude-mux/cmux/worktrees', title: 'cmux と git worktree', sectionId: 'cmux', manualId: 'claude-mux' },
  { step: 34, path: '/claude-mux/reference/session-management', title: '環境の永続化', sectionId: 'reference', manualId: 'claude-mux' },
  { step: 35, path: '/claude-mux/reference/troubleshooting', title: 'トラブルシューティング', sectionId: 'reference', manualId: 'claude-mux' },
  { step: 36, path: '/claude-mux/reference/claude-cheatsheet', title: 'Claude Code チートシート', sectionId: 'reference', manualId: 'claude-mux' },
  { step: 37, path: '/claude-mux/reference/tmux-cheatsheet', title: 'tmux チートシート', sectionId: 'reference', manualId: 'claude-mux' },
  { step: 38, path: '/claude-mux/best-practices/effective-workflows', title: '効果的なワークフロー', sectionId: 'best-practices', manualId: 'claude-mux' },
  { step: 39, path: '/claude-mux/best-practices/spec-driven-dev', title: '仕様駆動開発 (SDD)', sectionId: 'best-practices', manualId: 'claude-mux' },
  { step: 40, path: '/claude-mux/best-practices/testing-debugging', title: 'テストとデバッグの戦略', sectionId: 'best-practices', manualId: 'claude-mux' },
  { step: 41, path: '/claude-mux/hooks-advanced/hooks-guide', title: 'Hooks の設計と実装', sectionId: 'hooks-advanced', manualId: 'claude-mux' },
  { step: 42, path: '/claude-mux/hooks-advanced/hooks-recipes', title: 'Hooks 実践レシピ', sectionId: 'hooks-advanced', manualId: 'claude-mux' },
  { step: 43, path: '/claude-mux/ci-cd/github-actions', title: 'GitHub Actions 連携', sectionId: 'cicd-headless', manualId: 'claude-mux' },
  { step: 44, path: '/claude-mux/ci-cd/headless-mode', title: 'ヘッドレスモードと自動化', sectionId: 'cicd-headless', manualId: 'claude-mux' },
  { step: 45, path: '/claude-mux/ide-agent-teams/ide-integration', title: 'VS Code・JetBrains 連携', sectionId: 'ide-agent-teams', manualId: 'claude-mux' },
  { step: 46, path: '/claude-mux/ide-agent-teams/agent-orchestration', title: 'エージェントチームの協調', sectionId: 'ide-agent-teams', manualId: 'claude-mux' },
  { step: 47, path: '/claude-mux/ide-agent-teams/plugins-ecosystem', title: 'プラグインとエコシステム', sectionId: 'ide-agent-teams', manualId: 'claude-mux' },
  { step: 48, path: '/claude-mux/multi-ai/multi-ai-coexistence', title: 'マルチAIツールの共存戦略', sectionId: 'multi-ai-architecture', manualId: 'claude-mux' },
  { step: 49, path: '/claude-mux/multi-ai/single-source-of-truth', title: 'シングルソースオブトゥルース設計', sectionId: 'multi-ai-architecture', manualId: 'claude-mux' },

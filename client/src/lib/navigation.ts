...
export const pages: PageInfo[] = [
  ...
  { step: 16, path: '/claude-mux/mcp/mcp-setup', title: 'MCP (Model Context Protocol)', sectionId: 'mcp', manualId: 'claude-mux' },
  { step: 17, path: '/claude-mux/mcp/mcp-practical', title: '実践的な MCP 連携', sectionId: 'mcp', manualId: 'claude-mux' },

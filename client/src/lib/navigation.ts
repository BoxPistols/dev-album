...
export const pages: PageInfo[] = [
  ...
  { step: 11, path: '/api/rest-design/caching', title: 'HTTP キャッシュと条件付きリクエスト', sectionId: 'rest-design', manualId: 'api' },
  { step: 12, path: '/api/openapi/what-is-openapi', title: 'OpenAPI 仕様とは', sectionId: 'openapi', manualId: 'api' },
  { step: 13, path: '/api/openapi/document-structure', title: 'OpenAPI ドキュメントの構造', sectionId: 'openapi', manualId: 'api' },
  { step: 14, path: '/api/openapi/schema-components', title: 'スキーマとコンポーネント', sectionId: 'openapi', manualId: 'api' },
  { step: 15, path: '/api/openapi/swagger-ui', title: 'Swagger UI と Redoc', sectionId: 'openapi', manualId: 'api' },
  { step: 16, path: '/api/openapi/schema-first', title: 'スキーマファースト開発', sectionId: 'openapi', manualId: 'api' },
  { step: 17, path: '/api/build/mock-server', title: 'モックサーバーから始める', sectionId: 'api-build', manualId: 'api' },
  { step: 18, path: '/api/build/validation', title: '入力バリデーション', sectionId: 'api-build', manualId: 'api' },
  { step: 19, path: '/api/build/auth', title: '認証と認可', sectionId: 'api-build', manualId: 'api' },
  { step: 20, path: '/api/build/versioning', title: 'API バージョニング', sectionId: 'api-build', manualId: 'api' },
  { step: 21, path: '/api/quality/contract-testing', title: '契約テスト', sectionId: 'api-quality', manualId: 'api' },
  { step: 22, path: '/api/quality/linting', title: 'スキーマ Lint と Spectral', sectionId: 'api-quality', manualId: 'api' },
  { step: 23, path: '/api/quality/security', title: 'API セキュリティ設計', sectionId: 'api-quality', manualId: 'api' },
  { step: 24, path: '/api/advanced/beyond-rest', title: 'REST 以外の選択肢（GraphQL / gRPC）', sectionId: 'api-advanced', manualId: 'api' },
  { step: 25, path: '/api/advanced/summary', title: '設計まとめとチェックリスト', sectionId: 'api-advanced', manualId: 'api' },
];

...
export const pages: PageInfo[] = [
  ...
  { step: 13, path: '/claude-mux/mcp/mcp-setup', title: 'MCP (Model Context Protocol)', sectionId: 'mcp', manualId: 'claude-mux' },
  { step: 14, path: '/claude-mux/mcp/mcp-practical', title: '実践的な MCP 連携', sectionId: 'mcp', manualId: 'claude-mux' },
  { step: 15, path: '/claude-mux/agent-extensions/subagents', title: 'Subagents による並列処理', sectionId: 'agent-extensions', manualId: 'claude-mux' },
  { step: 16, path: '/claude-mux/agent-extensions/custom-skills', title: 'Skills・コマンド・Hooks', sectionId: 'agent-extensions', manualId: 'claude-mux' },
  { step: 17, path: '/claude-mux/agent-extensions/skills-deep-dive', title: 'Skills 深掘り', sectionId: 'agent-extensions', manualId: 'claude-mux' },
  { step: 18, path: '/claude-mux/ai-coding-agents/gemini-cli', title: 'Gemini CLI', sectionId: 'ai-coding-agents', manualId: 'claude-mux' },
  { step: 19, path: '/claude-mux/ai-coding-agents/openai-codex', title: 'OpenAI Codex', sectionId: 'ai-coding-agents', manualId: 'claude-mux' },
  { step: 20, path: '/claude-mux/ai-coding-agents/github-copilot', title: 'GitHub Copilot', sectionId: 'ai-coding-agents', manualId: 'claude-mux' },
  { step: 21, path: '/claude-mux/ai-coding-agents/amazon-q-developer', title: 'Amazon Q Developer', sectionId: 'ai-coding-agents', manualId: 'claude-mux' },
  { step: 22, path: '/claude-mux/ai-coding-agents/choosing-tools', title: 'ツールの選び方と使い分け', sectionId: 'ai-coding-agents', manualId: 'claude-mux' },
  { step: 23, path: '/claude-mux/cmux/cmux-intro', title: 'cmux: GUI ベースのエージェント管理', sectionId: 'cmux', manualId: 'claude-mux' },
  { step: 24, path: '/claude-mux/cmux/cmux-setup', title: 'cmux のセットアップと活用', sectionId: 'cmux', manualId: 'claude-mux' },
  { step: 25, path: '/claude-mux/cmux/agent-teams', title: 'cmux と Agent Teams', sectionId: 'cmux', manualId: 'claude-mux' },
  { step: 26, path: '/claude-mux/cmux/browser-api', title: 'ビルトインブラウザと Scriptable API', sectionId: 'cmux', manualId: 'claude-mux' },
  { step: 27, path: '/claude-mux/cmux/worktrees', title: 'cmux と git worktree', sectionId: 'cmux', manualId: 'claude-mux' },
  { step: 28, path: '/claude-mux/reference/troubleshooting', title: 'トラブルシューティング', sectionId: 'reference', manualId: 'claude-mux' },
  { step: 29, path: '/claude-mux/reference/claude-cheatsheet', title: 'Claude Code チートシート', sectionId: 'reference', manualId: 'claude-mux' },
  { step: 30, path: '/claude-mux/best-practices/harness-engineering', title: 'ハーネスエンジニアリング', sectionId: 'best-practices', manualId: 'claude-mux' },
  { step: 31, path: '/claude-mux/best-practices/effective-workflows', title: '効果的なワークフロー', sectionId: 'best-practices', manualId: 'claude-mux' },
  { step: 32, path: '/claude-mux/best-practices/verification-and-trust', title: '検証スキル — 無監督実行を信頼する', sectionId: 'best-practices', manualId: 'claude-mux' },
  { step: 33, path: '/claude-mux/best-practices/spec-driven-dev', title: '仕様駆動開発 (SDD)', sectionId: 'best-practices', manualId: 'claude-mux' },
  { step: 34, path: '/claude-mux/best-practices/testing-debugging', title: 'テストとデバッグの戦略', sectionId: 'best-practices', manualId: 'claude-mux' },
  { step: 35, path: '/claude-mux/hooks-advanced/hooks-guide', title: 'Hooks の設計と実装', sectionId: 'hooks-advanced', manualId: 'claude-mux' },
  { step: 36, path: '/claude-mux/hooks-advanced/hooks-recipes', title: 'Hooks 実践レシピ', sectionId: 'hooks-advanced', manualId: 'claude-mux' },
  { step: 37, path: '/claude-mux/ci-cd/github-actions', title: 'GitHub Actions 連携', sectionId: 'cicd-headless', manualId: 'claude-mux' },
  { step: 38, path: '/claude-mux/ci-cd/headless-mode', title: 'ヘッドレスモードと自動化', sectionId: 'cicd-headless', manualId: 'claude-mux' },
  { step: 39, path: '/claude-mux/ide-agent-teams/ide-integration', title: 'VS Code・JetBrains 連携', sectionId: 'ide-agent-teams', manualId: 'claude-mux' },
  { step: 40, path: '/claude-mux/ide-agent-teams/agent-orchestration', title: 'エージェントチームの協調', sectionId: 'ide-agent-teams', manualId: 'claude-mux' },
  { step: 41, path: '/claude-mux/ide-agent-teams/plugins-ecosystem', title: 'プラグインとエコシステム', sectionId: 'ide-agent-teams', manualId: 'claude-mux' },
  { step: 42, path: '/claude-mux/multi-ai/multi-ai-coexistence', title: 'マルチAIツールの共存戦略', sectionId: 'multi-ai-architecture', manualId: 'claude-mux' },
  { step: 43, path: '/claude-mux/multi-ai/single-source-of-truth', title: 'シングルソースオブトゥルース設計', sectionId: 'multi-ai-architecture', manualId: 'claude-mux' },
  { step: 44, path: '/claude-mux/multi-ai/agent-docs', title: 'CLAUDE.md / AGENTS.md / ARCHITECTURE.md', sectionId: 'multi-ai-architecture', manualId: 'claude-mux' },
  { step: 45, path: '/claude-mux/multi-ai/design-md', title: 'DESIGN.md', sectionId: 'multi-ai-architecture', manualId: 'claude-mux' },

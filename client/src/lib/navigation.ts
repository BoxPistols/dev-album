...
export const pages: PageInfo[] = [
  ...
  { step: 23, path: '/git/flow-automation/auto-test-refactor', title: '自動テストと自動修正（リファクタリング）', sectionId: 'flow-automation', manualId: 'git' },
  { step: 24, path: '/git/flow-automation/labels', title: 'ラベルと分類の自動化', sectionId: 'flow-automation', manualId: 'git' },
  { step: 25, path: '/git/flow-automation/assignment', title: 'アサインとレビューの自動割り当て', sectionId: 'flow-automation', manualId: 'git' },
  { step: 26, path: '/git/flow-automation/projects', title: 'GitHub Projects 連携', sectionId: 'flow-automation', manualId: 'git' },
  { step: 27, path: '/git/flow-automation/merge-governance', title: 'マージガバナンス（意図せぬマージの防止）', sectionId: 'flow-automation', manualId: 'git' },
  { step: 28, path: '/git/react/setup', title: 'React 開発環境セットアップ', sectionId: 'react-practice', manualId: 'git' },
  { step: 29, path: '/git/react/modify', title: 'デザイン変更と Git 管理', sectionId: 'react-practice', manualId: 'git' },
  { step: 30, path: '/git/advanced/wsl2', title: 'WSL2 導入', sectionId: 'advanced-setup', manualId: 'git' },
  { step: 31, path: '/git/advanced/wsl2-ssh', title: 'WSL2 での SSH キー接続', sectionId: 'advanced-setup', manualId: 'git' },
  { step: 32, path: '/git/advanced/github-cli', title: 'GitHub CLI 導入', sectionId: 'advanced-setup', manualId: 'git' },
  { step: 33, path: '/git/advanced/linux-basics', title: 'Linux/Ubuntu 基礎', sectionId: 'advanced-setup', manualId: 'git' },
  { step: 34, path: '/git/advanced/vscode', title: 'VSCode 導入', sectionId: 'advanced-setup', manualId: 'git' },
  { step: 35, path: '/git/advanced/integration', title: '開発環境の統合確認', sectionId: 'advanced-setup', manualId: 'git' },
  { step: 36, path: '/git/ai-agent/overview', title: 'AI コーディング環境の全体像', sectionId: 'ai-agent', manualId: 'git' },
  { step: 37, path: '/git/ai-agent/claude-code-setup', title: 'Claude Code 導入', sectionId: 'ai-agent', manualId: 'git' },
  { step: 38, path: '/git/ai-agent/claude-code-basics', title: 'Claude Code 基本操作', sectionId: 'ai-agent', manualId: 'git' },
  { step: 39, path: '/git/ai-agent/cursor-cline', title: 'Cursor + Cline 導入', sectionId: 'ai-agent', manualId: 'git' },
  { step: 40, path: '/git/ai-agent/sub-tools', title: '予備ツール（Gemini / Warp / Antigravity）', sectionId: 'ai-agent', manualId: 'git' },

...
export const pages: PageInfo[] = [
  ...
  { step: 7, path: '/api/rest-design/http-methods', title: 'HTTP メソッドの使い分け', sectionId: 'rest-design', manualId: 'api' },
  { step: 8, path: '/api/rest-design/status-codes', title: 'ステータスコード設計', sectionId: 'rest-design', manualId: 'api' },
  { step: 9, path: '/api/rest-design/request-response', title: 'リクエスト / レスポンス設計', sectionId: 'rest-design', manualId: 'api' },
  { step: 10, path: '/api/rest-design/pagination', title: 'ページネーション・フィルタ・ソート', sectionId: 'rest-design', manualId: 'api' },
  { step: 11, path: '/api/rest-design/error-handling', title: 'エラーレスポンス設計', sectionId: 'rest-design', manualId: 'api' },
  { step: 12, path: '/api/rest-design/caching', title: 'HTTP キャッシュと条件付きリクエスト', sectionId: 'rest-design', manualId: 'api' },
  { step: 13, path: '/api/rest-design/idempotency', title: 'べき等キーと安全なリトライ', sectionId: 'rest-design', manualId: 'api' },
  { step: 14, path: '/api/openapi/what-is-openapi', title: 'OpenAPI 仕様とは', sectionId: 'openapi', manualId: 'api' },
  { step: 15, path: '/api/openapi/document-structure', title: 'OpenAPI ドキュメントの構造', sectionId: 'openapi', manualId: 'api' },
  { step: 16, path: '/api/openapi/schema-components', title: 'スキーマとコンポーネント', sectionId: 'openapi', manualId: 'api' },
  { step: 17, path: '/api/openapi/swagger-ui', title: 'Swagger UI と Redoc', sectionId: 'openapi', manualId: 'api' },
  { step: 18, path: '/api/openapi/schema-first', title: 'スキーマファースト開発', sectionId: 'openapi', manualId: 'api' },
  { step: 19, path: '/api/build/mock-server', title: 'モックサーバーから始める', sectionId: 'api-build', manualId: 'api' },
  { step: 20, path: '/api/build/validation', title: '入力バリデーション', sectionId: 'api-build', manualId: 'api' },
  { step: 21, path: '/api/build/auth', title: '認証と認可', sectionId: 'api-build', manualId: 'api' },
  { step: 22, path: '/api/build/rate-limiting', title: 'レート制限とスロットリング', sectionId: 'api-build', manualId: 'api' },
  { step: 23, path: '/api/build/webhooks', title: 'Webhooks と非同期 API', sectionId: 'api-build', manualId: 'api' },
  { step: 24, path: '/api/build/versioning', title: 'API バージョニング', sectionId: 'api-build', manualId: 'api' },
  { step: 25, path: '/api/quality/contract-testing', title: '契約テスト', sectionId: 'api-quality', manualId: 'api' },
  { step: 26, path: '/api/quality/linting', title: 'スキーマ Lint と Spectral', sectionId: 'api-quality', manualId: 'api' },
  { step: 27, path: '/api/quality/security', title: 'API セキュリティ設計', sectionId: 'api-quality', manualId: 'api' },
  { step: 28, path: '/api/quality/observability', title: 'API の可観測性', sectionId: 'api-quality', manualId: 'api' },
  { step: 29, path: '/api/quality/debugging-tools', title: 'API のデバッグと GUI / CLI ツール', sectionId: 'api-quality', manualId: 'api' },
  { step: 30, path: '/api/collaboration/backend-frontend', title: 'バックエンドとフロントエンドの API 設計', sectionId: 'api-collaboration', manualId: 'api' },
  { step: 31, path: '/api/collaboration/design-and-api', title: 'デザイン・情報設計と API', sectionId: 'api-collaboration', manualId: 'api' },
  { step: 32, path: '/api/practice/react', title: 'React での API 連携', sectionId: 'api-practice', manualId: 'api' },
  { step: 33, path: '/api/practice/nextjs', title: 'Next.js での API 連携', sectionId: 'api-practice', manualId: 'api' },
  { step: 34, path: '/api/practice/vue', title: 'Vue での API 連携', sectionId: 'api-practice', manualId: 'api' },
  { step: 35, path: '/api/practice/nuxt', title: 'Nuxt での API 連携', sectionId: 'api-practice', manualId: 'api' },
  { step: 36, path: '/api/advanced/beyond-rest', title: 'REST 以外の選択肢（GraphQL / gRPC）', sectionId: 'api-advanced', manualId: 'api' },
  { step: 37, path: '/api/advanced/summary', title: '設計まとめとチェックリスト', sectionId: 'api-advanced', manualId: 'api' },
];

...
export const pages: PageInfo[] = [
  ...
  { step: 13, path: '/ai-ml/jev/jev-account', title: 'アカウント登録と API キー・課金の準備', sectionId: 'jev', manualId: 'ai-ml' },
  { step: 14, path: '/ai-ml/jev/jev-setup', title: 'Jev の開発環境構築', sectionId: 'jev', manualId: 'ai-ml' },

...
export const searchIndex: Record<string, string[]> = {
  ...
  '/claude-mux/multi-ai/agent-docs': ['CLAUDE.md', 'AGENTS.md', 'ARCHITECTURE.md', '3 層構造', 'アーキテクチャ', '意思決定', 'ADR', 'SSOT', '@import', 'ツール非依存', '.claude/rules', 'paths', 'compact'],
  '/claude-mux/multi-ai/design-md': ['DESIGN.md', 'Google Labs', 'Stitch', 'デザイントークン', 'front matter', 'WCAG', 'コントラスト比', 'Tailwind', 'DTCG', 'lint', 'デザインシステム'],
